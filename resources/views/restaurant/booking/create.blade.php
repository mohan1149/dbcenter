		...
		{!! Form::open(['url' => action('Restaurant\BookingController@store'), 'method' => 'post', 'id' => 'add_booking_form' ]) !!}
			<div class="modal-header">
				...
				<div class="modal-body">
                    ...
                    <div class="col-sm-6">
						<div class="form-group">
							{!! Form::label('count', __('lang_v1.customer_count') . ':*') !!}
	            			<div class='input-group date' >
	            			<span class="input-group-addon">
	                    		<span class="glyphicon glyphicon-calendar"></span>
	                		</span>
							{!! Form::number('count', 1, ['class' => 'form-control','placeholder' => __( 'lang_v1.customer_count' ), 'required']); !!}
							</div>
						</div>
					</div>
					<div class="col-sm-6">
						...
						<div class="form-group">
							<div class="input-group">
								...
								{!! Form::select('services', 
									$scategories, null, ['class' => 'form-control', 'id' => 'services']); !!}
							</div>
						</div>
					</div>
