...
function updatePurchaseSell() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $('.total_amount_paid').html(__currency_trans_from_en(data.total_paid_subscribers, true));
            $('.total_due_amount').html(__currency_trans_from_en(data.total_paid_subscribers - data.total_unpaid_subscribers, true));
            $('.net_profit').html(__currency_trans_from_en(data.total_paid_subscribers + data.total_unpaid_subscribers - data.total_paid_subscribers, true));
